print("^2Jim-Mining ^7v^42^7.^43^7.^41 ^7- ^2Mining Script by ^Infinity Labs^7")
...
Config = {
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(20000, 30000),
		["Washing"] = math.random(10000, 20000),
		["Panning"] = math.random(10000, 20000),
		["Pickaxe"] = math.random(15000, 25000),
		["Mining"] = math.random(20000, 30000),
		["Laser"] = math.random(10000, 15000),
		["OreRespawn"] = math.random(90000, 95000),
		["Crafting"] = 60000,
	},
	...
	Locations =  {
		['MineStore'] = {
			...
			--{ name = "Mine", coords = vector4(2960.9, 2754.14, 43.71, 204.58), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
			{ name = "Foundary", coords = vector4(1074.89, -1988.19, 30.89, 235.07), sprite = 468, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		},
		...
		["Washing"] = {
			...
			-- Roxwood stone wash
			{ name = "Stone Washing", coords = vector3(-1785.22, 7599.54, 132.97), sprite = 467, col = 3, blipTrue = true },
		...
		["Panning"] = {
			...
			-- Roxwood Gold Panning
			{ name = "Gold Panning", coords = vector3(-1876.28, 7585.53, 91.68), sprite = 467, col = 5, disp = 6, blipTrue = true }, 
		...
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "Jewel Buyer", coords = vector4(338.45, -965.23, 29.43, 0.95), sprite = 527, col = 617, blipTrue = true, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
	},
...
--Ores and Props
	...
	RoxwoodLocations = {
		---MineShaft Locations
		vector4(-1726.43, 7687.05, 108.93, 248.61),
		vector4(-1728.85, 7688.13, 109.01, 63.37),
		vector4(-1720.47, 7648.32, 94.49, 282.82),
		vector4(-1723.58, 7652.99, 94.85, 10.9),
		vector4(-1728.25, 7655.8, 95.9, 39.47),
		vector4(-1730.18, 7662.62, 97.24, 86.35),
		vector4(-1721.18, 7641.24, 93.9, 134.65),
		vector4(-1717.39, 7638.08, 91.75, 137.29),
		vector4(-1715.18, 7641.59, 92.55, 344.02),
		vector4(-1691.53, 7633.27, 82.03, 339.51),
		vector4(-1678.48, 7630.96, 74.86, 184.92),
		vector4(-1671.13, 7632.56, 75.26, 274.6),
		vector4(-1674.89, 7612.6, 75.28, 95.5),
		vector4(-1671.89, 7604.74, 75.19, 216.77),

		-- Big open cave area
		vector4(-1663.99, 7727.95, 94.14, 344.8),
		vector4(-1648.87, 7725.35, 94.64, 290.76),
		vector4(-1645.09, 7704.18, 93.66, 184.35),
		vector4(-1631.78, 7700.07, 91.54, 220.03),
		vector4(-1611.65, 7695.56, 93.87, 274.38),
		vector4(-1609.42, 7685.57, 92.6, 275.93),
		vector4(-1616.32, 7670.65, 90.62, 237.44),
		vector4(-1636.44, 7675.58, 91.3, 71.93),
		vector4(-1646.77, 7664.08, 87.72, 94.56),
		vector4(-1664.4, 7654.29, 93.95, 126.6),
		vector4(-1685.32, 7674.94, 95.12, 69.36),
		vector4(-1679.8, 7693.06, 92.39, 326.16),
		vector4(-1664.47, 7702.58, 94.42, 281.58),
		vector4(-1663.65, 7676.82, 92.85, 300.73),
	},
...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['emerald_ring_silver'] = 740,
		['ruby_ring_silver'] = 730,
		['sapphire_ring_silver'] = 720,

		-- GOLD NECKLACES
		['diamond_necklace'] = 950,
		['emerald_necklace'] = 940,
		['ruby_necklace'] = 930,
		['sapphire_necklace'] = 920,

		-- SILVER NECKLACES
		['diamond_necklace_silver'] = 900,
		['emerald_necklace_silver'] = 990,
		['ruby_necklace_silver'] = 980,
		['sapphire_necklace_silver'] = 970,

		-- GOLD EARRINGS
		['diamond_earring'] = 750,
		['emerald_earring'] = 740,
		['ruby_earring'] = 730,
		['sapphire_earring'] = 720,

		-- SILVER EARRING
		['diamond_earring_silver'] = 725,
		['emerald_earring_silver'] = 715,
		['ruby_earring_silver'] = 705,
		['sapphire_earring_silver'] = 695,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 300, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 275, amount = 250, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 500, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "weapon_flashlight", price = 1500, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 1000, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 200, amount = 100, info = {}, type = "item", slot = 6, },
...
Crafting = {
	SmeltMenu = {
		...
		{ ["goldingot"] = { ["gold_ring"] = 2 } },
		{ ["silveringot"] = { ["silverore"] = 2 } },
		{ ["silveringot"] = { ["silverchain"] = 2 } },
		{ ["silveringot"] = { ["silver_ring"] = 2 } },
		{ ["iron"] = { ["ironore"] = 1 } },
		{ ["steel"] = { ["ironore"] = 1, ["carbon"] = 1 } },
		{ ["aluminum"] = { ["can"] = 2, }, ['amount'] = 1 },
		{ ["glass"] = { ["bottle"] = 2, }, ['amount'] = 2 },
	},
	GemCut = {
		{ ["emerald"] = { ["uncut_emerald"] = 2, } },
		{ ["diamond"] = { ["uncut_diamond"] = 2}, },
		{ ["ruby"] = { ["uncut_ruby"] = 2 }, },
		{ ["sapphire"] = { ["uncut_sapphire"] = 2 }, },
	},
	RingCut = {
		{ ["gold_ring"] = { ["goldingot"] = 1 }, ['amount'] = 2 },
		{ ["silver_ring"] = { ["silveringot"] = 1 }, ['amount'] = 2 },
	...
	NeckCut = {
		{ ["goldchain"] = { ["goldingot"] = 1 }, ['amount'] = 1  },
		{ ["silverchain"] = { ["silveringot"] = 1 }, ['amount'] = 1  },
...
K4MB1 = {
	['MineStore'] = {
		--{ name = "Cave Shop", coords = vector4(2908.8, 2643.6, 43.26, 328.32), sprite = 527, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },		-- The location where you enter the mine
	},
